...
void Map::draw(Camera camera, SDL_Renderer *renderer) const {
    if (!Map::Textures::TexturesWereLoaded) {
        Map::Textures::SolidTiles = IMG_LoadTexture(renderer, LinkManager::path("data/images/tiles/solid.png", true).c_str());
        Map::Textures::DangerousTiles = IMG_LoadTexture(renderer, LinkManager::path("data/images/tiles/dangerous.png", true).c_str());
        Map::Textures::DecorationTiles = IMG_LoadTexture(renderer, LinkManager::path("data/images/tiles/decoration.png", true).c_str());
